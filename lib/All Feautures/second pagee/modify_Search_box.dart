...
class ModifySearchBoxState extends State<ModifySearchBox> {
  ...
  void newUpdatedValues() {
    setState(() {
      ...
      if (selectedJourneyType == 'One Way') {
        ...
        returnFrom = fromStationController.text;
        returnTo = toStationController.text;
        returnDate = _returnDateController.text;
        returnJourneyClass = selectedReturnClass ?? '';
      }
    });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Modify Search Example')),
                                    ...
                                    onPressed: () {
                                      ...
                                      if (isFormValid()) {
                                        ...
                                        MaterialPageRoute(
                                          ...
                                          returnFromStation: returnFrom,
                                          returnToStation: returnTo,
